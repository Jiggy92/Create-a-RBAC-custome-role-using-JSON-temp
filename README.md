...
--Task 1:Create a JSON file with custom RBAC role:-
...
Task 2: **Upload the saved JSON file in Azure Cloud Shell to the right of the search box**

Task 3: **After uploading the file run command "New-AzRoleDefinition -InputFile $HOME/az104-02a-customRoleDefinition.json"
